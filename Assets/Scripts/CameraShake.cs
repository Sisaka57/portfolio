...
public class CameraShake : MonoBehaviour
{
  ...
  //  [HideInInspector]
    ...
    private Quaternion _camera;

    private void Start()
    {
	    if (Camera.main != null) _camera = Camera.main.transform.rotation;
    }
	...
	public void allow_to_shake()
    {
        isPlaying = true;
        if(FindObjectsOfType(typeof(CameraShake)) is CameraShake[] shakes)
...

    {
		...
		var originalCamRotation = _camera.eulerAngles;
